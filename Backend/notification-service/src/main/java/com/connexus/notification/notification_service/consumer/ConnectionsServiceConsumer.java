...
import com.connexus.notification.connection_service.event.AcceptConnectionRequestEvent;
import com.connexus.notification.connection_service.event.SendConnectionRequestEvent;
...
public class ConnectionsServiceConsumer {
    ...
    public void handleAcceptConnectionRequest(AcceptConnectionRequestEvent acceptConnectionRequestEvent) {
        ...
        String message = String.format(
                "Your connection request has been accepted by the user with id: %d",
